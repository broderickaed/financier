                        ...
                        <Dialog>
                            ...
                            <DialogContent>
                                <DialogHeader>
                                    ...
                                    <DialogDescription>This action cannot be undone. This will permanently delete the transaction.</DialogDescription>
                                </DialogHeader>
                                <DialogFooter>
                ...
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Select value={data.category_id} onValueChange={(value) => handleChange('category_id', value)} disabled={processing}>
                        ...
                        <div className="space-y-2">
                            ...
                            <Select value={data.type} onValueChange={(value) => handleChange('type', value)} disabled={processing}>
                        ...
                        <div className="space-y-2">
                            ...
                            <Select value={data.account_id} onValueChange={(value) => handleChange('account_id', value)} disabled={processing}>
                        ...
                        {data.type === 'transfer' && (
                            <div className="space-y-2">
                                ...
                                {errors.related_account_id && <p className="text-sm text-red-500">{errors.related_account_id}</p>}
                            </div>
                        )}
